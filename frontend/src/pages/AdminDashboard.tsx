...
const AdminDashboard: React.FC = () => {
  ...
  const TopBar = () => (
    <div className="glass-card mx-8 my-4 px-6 py-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="gradient-text text-2xl font-bold font-['Orbitron'] tracking-wider">
        ...
        <div className="flex items-center space-x-4">
          <button className="relative p-2 rounded-full bg-gray-800 hover:bg-gray-700 transition-colors border border-cyan-500/30">
          ...
          <button
            ...
            className="btn-accent-futuristic px-6 py-2 text-sm font-['Rajdhani'] font-bold tracking-wider flex items-center space-x-2 group"
          >
          ...
          <div className="flex items-center space-x-3">
            <div className="bg-gradient-to-br from-cyan-500 to-blue-600 p-2 rounded-full neon-pulse">
              <span className="text-white font-bold text-sm font-['Rajdhani']">AD</span>
            </div>
            <div className="text-right">
              <span className="font-bold text-white text-sm font-['Rajdhani']">
                {currentUser?.firstName || 'Admin'} {currentUser?.lastName || 'User'}
              </span>
              <p className="text-cyan-400 text-xs font-['Rajdhani'] tracking-wide">
